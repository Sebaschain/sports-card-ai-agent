...
class PricePoint(BaseModel):
    ...
    timestamp: datetime = Field(default_factory=datetime.now, description="Fecha del precio")
...
class PriceHistory(BaseModel):
    ...
    prices: List[PricePoint] = Field(default_factory=list, description="Lista de precios")
...
class PlayerStats(BaseModel):
    ...
    recent_performance: str = Field(..., description="Descripción de rendimiento reciente")
...
class TradingRecommendation(BaseModel):
    ...
    target_buy_price: Optional[float] = Field(None, description="Precio objetivo de compra")
    target_sell_price: Optional[float] = Field(None, description="Precio objetivo de venta")
